...
If you are in the self-hosted version of Supabase and you want to change the additional_redirect_urls you have to write them down without any additional signs and without square brackets -> ADDITIONAL_REDIRECT_URLS=http://localhost:3000,http://localhost:3000/*
